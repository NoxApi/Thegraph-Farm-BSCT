...
export class EvermoonFarmChapel__poolInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class EvermoonFarmChapel__updatePoolResultPoolStruct extends ethereum.Tuple {
  get accEvermoonPerShare(): BigInt {
...
export class EvermoonFarmChapel__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class EvermoonFarmChapel extends ethereum.SmartContract {
  static bind(address: Address): EvermoonFarmChapel {
    return new EvermoonFarmChapel("EvermoonFarmChapel", address);
  }
  ...
  poolInfo(param0: BigInt): EvermoonFarmChapel__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new EvermoonFarmChapel__poolInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<EvermoonFarmChapel__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(uint128,uint64,uint64)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new EvermoonFarmChapel__poolInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  updatePool(pid: BigInt): EvermoonFarmChapel__updatePoolResultPoolStruct {
    let result = super.call(
      "updatePool",
    ...
    return changetype<EvermoonFarmChapel__updatePoolResultPoolStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_updatePool(
    pid: BigInt
  ): ethereum.CallResult<EvermoonFarmChapel__updatePoolResultPoolStruct> {
    let result = super.tryCall(
      "updatePool",
      "updatePool(uint256):((uint128,uint64,uint64))",
      [ethereum.Value.fromUnsignedBigInt(pid)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<EvermoonFarmChapel__updatePoolResultPoolStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  userInfo(
    param0: BigInt,
    param1: Address
  ): EvermoonFarmChapel__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new EvermoonFarmChapel__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<EvermoonFarmChapel__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EvermoonFarmChapel__userInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
