...
import {
  ...
  Withdraw
} from "../generated/EvermoonFarmChapel/EvermoonFarmChapel"
...
export function handleDeposit(event: Deposit): void {
  ...
  //
  // - contract.EVERMOON(...)
  // - contract.evermoonPerSecond(...)
  // - contract.lpToken(...)
  // - contract.owner(...)
  // - contract.pendingEvermoon(...)
...
export function handleLogEvermoonPerSecond(event: LogEvermoonPerSecond): void {}
